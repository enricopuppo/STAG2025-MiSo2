...
% It seems that libertinus already loads the inconsolata font, so adding the package for that results in a conflict. Specifying the correct font family is enough.
