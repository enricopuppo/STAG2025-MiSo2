...
Since such a kind of expressions are useful in diverse graphics applications (e.g. nonlinear element inversion, collision detection, boolean operations), in this paper we describe the design principles of our TIGHT library for interval arithmetic which always produces as-tight-as-possible intervals, is faster than any existing library, and supports transcendental functions.
