...
%aggiunto "in graphics", tolto "especially in simulations"
...
%
%The IEEE 754 standard for floating point arithmetic prescribes CR results only for the algebraic operations and the square root; all other operations are just \emph{recommended} to be correctly rounded, but there is no guarantee, depending on their implementation.
...
We are committed to making TIGHT a usable piece of software: unlike a large share of other related libraries, TIGHT can be easily integrated into CMake projects. Its source code is available at \url{https://gitlab.com/fsichetti/tight}.
