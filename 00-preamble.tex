...
\newcommand{\intlo}[1]{{[#1]}_{\operatorname{lo}}}
\newcommand{\inthi}[1]{{[#1]}_{\operatorname{hi}}}
\newcommand{\inclusion}[1]{\Box #1}

\newcommand{\sinpi}{\operatorname{sinpi}}
\newcommand{\cospi}{\operatorname{cospi}}
\newcommand{\tanpi}{\operatorname{tanpi}}
