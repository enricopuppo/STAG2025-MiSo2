...
These problems involve heavy use of trigonometric functions which, as outlined in Section \ref{}, are more expensive to compute in TIGHT \MA{Questo non era a causa di un errore di implementazione? Non siamo più veloci adesso? O e solo sull'insieme come detto qui di seguito?} than in Filib++.
